                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label for="regidateInput">Clock-In:</label>
                                        <div class="input-group">
                                                <input class="form-control date-picker date_of_birth" id="id-date-picker-1" type="text" name="dob" value="" data-date-format="dd-mm-yy" placeholder="DD/MM/YYYY">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label for="regidateInput">Clock-Out:</label>
                                        <div class="input-group">
                                            <input class="form-control date-picker date_of_birth" id="id-date-picker-1" type="text" name="dob" value="" data-date-format="dd-mm-yy" placeholder="DD/MM/YYYY">
                                            <span class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
...
<!--                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                    <div class="col-lg-8 col-sm-8 col-xs-8">aa</div>
                                    <div class="col-lg-4 col-sm-4 col-xs-4"><input type="checkbox" name="skill[]" value="4" checked="checked" class="colored-blue">b</div>
                                </div>-->
<!--                            <input type="text" name="field_name[]" value="" class="col-md-6" placeholder="Text Here">-->
                                    <span class="col-md-6">Checklist here!</span>
                                    
                                    <span class='col-md-4'>Checkbox here!</span>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="fileinput-button">
                                        <span class="btn btn-info">
                                            <input type="file" class="fileupload" multiple name="" data-url="" accept=".docx, application/pdf, application/msword, image/*" data-type="" >
                                            <i class="glyphicon glyphicon-upload"></i> Upload 
                                        </span>     
                                        <br/>
                                        <span class="d">Only Images are accepted</span>                       
